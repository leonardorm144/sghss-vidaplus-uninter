...
$pageTitle = 'Pacientes';
$pageSubtitle = 'Cadastro e consulta de pacientes pela recepção';
$menuAtivo = 'pacientes';
...
<section class="page-actions">
    <div>
        <h2>Pacientes</h2>
        <p>Gerencie o cadastro dos pacientes atendidos pela unidade.</p>
    </div>

    <a href="<?= BASE_URL ?>recepcao/paciente_form.php" class="btn btn-primary-small">
        Novo Paciente
    </a>
</section>
...
<section class="panel">
    <form method="get" class="search-form">
        ...
        <?php if ($busca !== ''): ?>
            <a href="<?= BASE_URL ?>recepcao/pacientes.php?por_pagina=<?= (int)$porPagina ?>" class="btn btn-light">
                Limpar
            </a>
        <?php endif; ?>
    </form>
            ...
            <tbody>
                ...
                <?php foreach ($pacientes as $paciente): ?>
                    <tr>
                        ...
                        <td class="text-right">
                            <a 
                                href="<?= BASE_URL ?>recepcao/paciente_form.php?id=<?= (int)$paciente['id'] ?>" 
                                class="btn btn-light"
                            >
                                Editar
                            </a>
                            ...
                            <a 
                                href="<?= BASE_URL ?>recepcao/paciente_acesso.php?id=<?= (int)$paciente['id'] ?>" 
                            ...
                            <form 
                                method="post" 
                                action="<?= BASE_URL ?>recepcao/paciente_excluir.php" 
                                class="inline-form"
        ...
        <?php if ($totalPaginas > 1): ?>
            <div class="pagination-pages">
                ...
                <a 
                    ...
                    href="<?= BASE_URL ?>recepcao/pacientes.php?<?= http_build_query(array_merge($queryBase, ['pagina' => $paginaAnterior])) ?>"
                >
                    Anterior
                </a>
                ...
                <?php if ($inicio > 1): ?>
                    <a 
                        ...
                        href="<?= BASE_URL ?>recepcao/pacientes.php?<?= http_build_query(array_merge($queryBase, ['pagina' => 1])) ?>"
                    >
                        1
                    </a>
                ...
                <?php for ($pagina = $inicio; $pagina <= $fim; $pagina++): ?>
                    <a 
                        ...
                        href="<?= BASE_URL ?>recepcao/pacientes.php?<?= http_build_query(array_merge($queryBase, ['pagina' => $pagina])) ?>"
                    >
                        <?= $pagina ?>
                    </a>
                <?php endfor; ?>
                ...
                <?php if ($fim < $totalPaginas): ?>
                    ...
                    <a 
                        class="pagination-link"
                        href="<?= BASE_URL ?>recepcao/pacientes.php?<?= http_build_query(array_merge($queryBase, ['pagina' => $totalPaginas])) ?>"
                    >
                        <?= $totalPaginas ?>
                    </a>
                <?php endif; ?>
                ...
                <a 
                    ...
                    href="<?= BASE_URL ?>recepcao/pacientes.php?<?= http_build_query(array_merge($queryBase, ['pagina' => $proximaPagina])) ?>"
                >
                    Próxima
                </a>
            </div>
