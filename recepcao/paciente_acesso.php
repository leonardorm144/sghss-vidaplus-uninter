...
function gerarTelefoneWhatsappPaciente($telefone)
{
    ...
    /*
     * Se o telefone tiver 10 ou 11 dígitos, considera Brasil e adiciona 55.
    ...
    /*
     * Se já vier com código do país, mantém.
     */
    if (strlen($numero) >= 12) {
        return $numero;
    }
...
<section class="patient-access-hero">
    <div class="patient-access-info">
        <span class="about-kicker">Área da Recepção</span>
...
<section class="panel">
    <div class="patient-access-actions-header">
        ...
        <?php if (!$usuario): ?>
            <form 
                method="post" 
                action="<?= BASE_URL ?>recepcao/paciente_acesso_salvar.php" 
