...
if ($acao === 'criar') {
    ...
    registrarAuditoria(
        $pdo,
        $_SESSION['usuario_id'],
        'ACESSO_PACIENTE_CRIADO_ADMIN',
        'usuarios',
        $usuarioId,
        'Acesso criado/recriado pelo administrador para o paciente: ' . $paciente['nome']
    );
...
if ($acao === 'resetar') {
    ...
    registrarAuditoria(
        $pdo,
        $_SESSION['usuario_id'],
        'ACESSO_PACIENTE_SENHA_RESETADA_ADMIN',
        'usuarios',
        $usuarioId,
        'Senha inicial redefinida pelo administrador para o paciente: ' . $paciente['nome']
    );
