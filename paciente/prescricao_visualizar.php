...
$pacienteLogado = $stmtPaciente->fetch();
...
$stmt = $pdo->prepare("
    ...
    WHERE ps.id = :id
    AND ps.paciente_id = :paciente_id
    AND ps.ativo = 1
    LIMIT 1
");
...
<section class="page-actions no-print">
    <div>
        ...
        <p>Visualize sua prescrição e utilize a opção de impressão.</p>
    </div>
    ...
    <div class="actions-inline">
        ...
        <a href="<?= BASE_URL ?>paciente/historico.php" class="btn btn-light">
            Voltar
        </a>
    </div>
</section>
